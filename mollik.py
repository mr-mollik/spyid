#!/usr/bin/python2
	...
	\033[1;96m               | |                      
	\033[1;96m               |_|   MOLLIK Updated 0.3                   
	\033[1;91m       ♦♦♦———————————Mr_Mollik————————————♦♦♦
	"""
	def tik():
		titik = ['.   ','..  ','... ']
	...
	jalan("   \033[1;93m Welcome to MOLLIK Creations ")
	

	jalan("\033[1;97m•◈•──────────•◈•\033[1;96mBlacktiger\033[1;96m•◈•──────────•◈•")
	

	CorrectUsername = "mollik"
	CorrectPassword = "mollik"
	...
	def pilih_super():
		...
		print "   \033[1;31;48m●💋═══════════════Mr_Mollik════════════════💋●"
	

		jalan('                    \033[1;97mAahil start cloning Wait...')
		print  "  \033[1;36;48m ●💋══════════════Mr_Mollik═══════════════💋●" 
